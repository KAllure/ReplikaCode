...
from cakechat.config import W2V_WINDOW_SIZE, W2V_MODEL_DIR, USE_SKIP_GRAM, WINDOW_SIZE, TOKEN_REPRESENTATION_SIZE
...
def get_w2v_params_str(voc_size, vec_size, window_size=WINDOW_SIZE, skip_gram=USE_SKIP_GRAM):
...
def get_w2v_model_path(corpus_name, voc_size, vec_size, window_size=WINDOW_SIZE, skip_gram=USE_SKIP_GRAM):
...
def get_w2v_model_name(corpus_name, voc_size, vec_size, window_size=WINDOW_SIZE, skip_gram=USE_SKIP_GRAM):
    params_str = get_w2v_params_str(voc_size, vec_size, window_size, skip_gram)
    model_name = '{}_{}'.format(corpus_name, params_str)
    return model_name
