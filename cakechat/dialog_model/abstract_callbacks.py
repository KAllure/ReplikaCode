"""
Essentials for using training callbacks together with luka-ml.
...
class _AbstractCallback(object, metaclass=abc.ABCMeta):
    """
    Common interface for training callbacks used with luka-ml models
    """
...
class ParametrizedCallback(_AbstractCallback):
    ...
    If you are going to use one of the stock keras callbacks, please choose one of the following options:
        1. Use this class to instantiate a luka-ml friendly callback object. Specify `callback_params` if the callback
