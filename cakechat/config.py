...
MODEL_NAME = 'cakechat_v4.1_cudnn'
...
W2V_MODEL_DIR = os.path.join(RESULTS_PATH, 'w2v_models')  # Path to store & load trained word2vec models
...
# training params
EPOCHS_NUM = 4  # Total epochs num
BATCH_SIZE = 196  # Number of samples to be used for gradient estimation on each train step
...
HOROVOD_WORKERS_NUM = 4  # Number of parallel processes that will be created to train your model
LEARNING_RATE = 4.0  # Learning rate for Adadelta optimzer. If training in distributed fashion
# using horovod, learning rate is scaled by the number of workers. See # https://github.com/uber/horovod#usage
